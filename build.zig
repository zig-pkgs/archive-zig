...
pub fn build(b: *std.Build) void {
    ...
    lib.addConfigHeader(b.addConfigHeader(.{
        ...
        .HAVE_LZ4HC_H = true,
        .HAVE_LZ4_H = true,
        .HAVE_LZMA_FILTER_ARM64 = true,
        .HAVE_LZMA_H = true,
        .HAVE_LZMA_STREAM_ENCODER_MT = true,
        ...
        .HAVE_PIPE = true,
        .HAVE_PKCS5_PBKDF2_HMAC_SHA1 = true,
        .HAVE_POLL = true,
        .HAVE_POLL_H = true,
        ...
        .PCRE_STATIC = null,
        .SIZEOF_INT = lib.target_info.target.c_type_byte_size(.int),
        .SIZEOF_LONG = lib.target_info.target.c_type_byte_size(.long),
        .SIZEOF_WCHAR_T = @as(u3, switch (lib.target_info.target.os.tag) {
            .windows => 2,
            else => 4,
        }),
        .STDC_HEADERS = true,
